...
export default function CheckboxMy({checkboxValue, setCheckboxValue, color}: propsType) {
//      const {  children, color = "blue", ripple = true } = props;
            ...
            <label className="inline-flex items-center mx-auto w-64">
                <div className={clsx(
                    ...
                    <input
                        ...
                        type="checkbox"
                        className={clsx(
                            "peer sr-only h-6 w-6 bg-gray-100 border-gray-500 border-3 rounded",
                            {
